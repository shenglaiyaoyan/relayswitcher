# components.md — 共享 UI 原语

框架: React 18 + Vite,无组件库,全部自绘(Neural Noir 设计系统)。CSS 为单一 `src/styles.css`(vanilla CSS 变量)。

## src/components/ui.jsx
所有共享原语集中在这一个文件:Icon(内联 SVG 图标系统)、Select(深色自定义下拉)、Modal、Confirm、Toggle、Field、Empty、Spinner、fmtK/fmtAgo/planLabel 工具。
